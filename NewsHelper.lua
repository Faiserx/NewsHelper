...
local update_path = getWorkingDirectory() .. "/update.ini" -- tozhe ssilka

local script_url = "https://raw.githubusercontent.com/Faiserx/NewsHelper/refs/heads/main/NewsHelper.lua" -- ssilka
